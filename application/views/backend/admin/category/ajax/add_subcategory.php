    ...
    $(function() {
        $("#subcategory_form").bind("submit", function() {
            ...
            $.ajax({
                type: "POST",
                cache: false,
                url: "<?php echo base_url(); ?>admin/categorycontroller/save_subcategory",
...
<fieldset>
    ...
    <legend>Subcategory information</legend>

    <?php
    echo form_open('admin/categorycontroller/save_subcategory', array("id" => "subcategory_form"));
    ?>
