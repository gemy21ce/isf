        ...
        if(settings.controlNav){
            ...
            for(var i = 0; i < kids.length; i++){
                if(settings.controlNavThumbs){
                    ...
                    nivoControl.append('<a class="nivo-control" rel="'+ i +'">'+ (i + 1) +'<span class="bg-pagination"></span></a>');
                }
                
            }
            if ($.browser.msie && $.browser.version < 10) {
				nivoControl.find('.bg-pagination').css({opacity:'0'});
				$('.nivo-controlNav a').hover(function(){
						$(this).find('.bg-pagination').stop().animate({opacity:1})
					}, function(){
						$(this).find('.bg-pagination').stop().animate({opacity:0})
				});	
			}
