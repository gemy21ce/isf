...
var JUI = function (options) {
        ...
        var jconfirmedId = 'jconfirmed_' + versionId,
            jdelete_popupId = 'jdelete_popup_' + versionId,
            joverlayId = 'joverlay_' + versionId,
            jmessageId = 'jmessage_delete_' + versionId,
            jcancelId = 'jcancel_' + versionId,
            jloading_overlayId = 'jloading_overlay_' + versionId;

        /**
         * that function to use internally to build the html elements.
         * @param {type} loadingMessage the message of the loading in jloading function.
         * @param {type} cancelLabel the label of the cancel button to use in jconfirm.
         * @param {type} OkLabel the label of the ok button in jalert and jconfirm.
         * @param {type} addCancel a boolean to check if it should show the cancel button or not, so it'll be available in jconfrim.
         */
        var buildHTML = function (loadingMessage, cancelLabel, OkLabel, addCancel) {
                ...
                if (settings.popup.class_name !== null) {
                    ...
                    popup.setAttribute("style", "line-height:20px;width: 400px; border: 10px solid #222; -webkit-border-radius: 15px;-moz-border-radius: 15px;border-radius: 15px;" + "padding: 10px 0; background: " + settings.popup.background_color + " repeat-x 0 -1px;color: #323232;position: absolute;z-index: 1200;");
                } else {
                    popup.setAttribute("style", "line-height:20px;width: 400px; border: 1em solid #edeff0; -webkit-border-radius: 15px;-moz-border-radius: 15px;border-radius: 15px;" + "padding: 10px 0; background: white repeat-x 0 -1px;color: #323232;position: absolute;z-index: 1200;");
                }
                ...
                if (true) {
                    ...
                    if (settings.buttons.class_name !== null) {
                        ...
                        aCancel.setAttribute("style", "float:right !important;margin-left: 5px;border: 1px solid " + settings.buttons.backgroun_color + ";" + "color: white;" + "text-align: center;" + "padding: 0 8px;" + "font-weight:bold;" + "background-color: " + settings.buttons.backgroun_color + ";" + "background-image: -webkit-gradient(linear, left top, left bottom, from(#0071c5), to(#4787ed));" + "background-image: -webkit-linear-gradient(top, #0071c5, #0071c5);" + "background-image: -moz-linear-gradient(top, " + settings.buttons.backgroun_color + ", " + settings.buttons.backgroun_color + ");" + "background-image: -ms-linear-gradient(top, " + settings.buttons.backgroun_color + ", " + settings.buttons.backgroun_color + ");" + "background-image: -o-linear-gradient(top, " + settings.buttons.backgroun_color + ", " + settings.buttons.backgroun_color + ");" + "background-image: linear-gradient(top, " + settings.buttons.backgroun_color + ", " + settings.buttons.backgroun_color + ");" + "-webkit-border-radius: 2px;" + "-moz-border-radius: 2px;" + "border-radius: 2px;" + "-webkit-user-select: none;" + "-moz-user-select: none;" + "user-select: none;" + "cursor: default;" + "display: inline-block;" + "text-align: center;" + "color: #fff;" + "font-size: 11px;" + "font-weight: bold;" + "height: 27px;" + "padding: 0 8px;" + "line-height: 27px;" + "line-height: 29px;" + "vertical-align: bottom;" + "height: 32px;" + "font-size: 13px;" + "color:#fff;" + "font-family: 'open sans';" + "margin: 0 0 0 2px;" + "height: 30px;" + "line-height: 30px;" + "color:#fff;cursor:pointer;margin-right: 20px;");
                    } else {
                        aCancel.setAttribute("style", "float:right !important;margin-left: 5px;border: 1px solid #0071c5;" + "color: white;" + "text-align: center;" + "padding: 0 8px;" + "font-weight:bold;" + "background-color: #0071c5;" + "background-image: -webkit-gradient(linear, left top, left bottom, from(#0071c5), to(#4787ed));" + "background-image: -webkit-linear-gradient(top, #0071c5, #0071c5);" + "background-image: -moz-linear-gradient(top, #0071c5, #0071c5);" + "background-image: -ms-linear-gradient(top, #0071c5, #0071c5);" + "background-image: -o-linear-gradient(top, #0071c5, #0071c5);" + "background-image: linear-gradient(top, #0071c5, #0071c5);" + "-webkit-border-radius: 2px;" + "-moz-border-radius: 2px;" + "border-radius: 2px;" + "-webkit-user-select: none;" + "-moz-user-select: none;" + "user-select: none;" + "cursor: default;" + "display: inline-block;" + "text-align: center;" + "color: #fff;" + "font-size: 11px;" + "font-weight: bold;" + "height: 27px;" + "padding: 0 8px;" + "line-height: 27px;" + "line-height: 29px;" + "vertical-align: bottom;" + "height: 32px;" + "font-size: 13px;" + "color:#fff;" + "font-family: 'open sans';" + "margin: 0 0 0 2px;" + "height: 30px;" + "line-height: 30px;" + "color:#fff;cursor:pointer;margin-right: 20px;");
                    }
                ...
                if (settings.buttons.class_name !== null) {
                    ...
                    aconfirmed.setAttribute("style", "float:right !important;margin-left: 5px;border: 1px solid " + settings.buttons.backgroun_color + ";" + "color: white;" + "text-align: center;" + "padding: 0 8px;" + "font-weight:bold;" + "background-color: " + settings.buttons.backgroun_color + ";" + "background-image: -webkit-gradient(linear, left top, left bottom, from(#0071c5), to(#4787ed));" + "background-image: -webkit-linear-gradient(top, #0071c5, #0071c5);" + "background-image: -moz-linear-gradient(top, " + settings.buttons.backgroun_color + ", " + settings.buttons.backgroun_color + ");" + "background-image: -ms-linear-gradient(top, " + settings.buttons.backgroun_color + ", " + settings.buttons.backgroun_color + ");" + "background-image: -o-linear-gradient(top, " + settings.buttons.backgroun_color + ", " + settings.buttons.backgroun_color + ");" + "background-image: linear-gradient(top, " + settings.buttons.backgroun_color + ", " + settings.buttons.backgroun_color + ");" + "-webkit-border-radius: 2px;" + "-moz-border-radius: 2px;" + "border-radius: 2px;" + "-webkit-user-select: none;" + "-moz-user-select: none;" + "user-select: none;" + "cursor: default;" + "display: inline-block;" + "text-align: center;" + "color: #fff;" + "font-size: 11px;" + "font-weight: bold;" + "height: 27px;" + "padding: 0 8px;" + "line-height: 27px;" + "line-height: 29px;" + "vertical-align: bottom;" + "height: 32px;" + "font-size: 13px;" + "color:#fff;" + "font-family: 'open sans';" + "margin: 0 0 0 2px;" + "height: 30px;" + "line-height: 30px;" + "color:#fff;cursor:pointer;margin-right: 20px;");
                } else {
                    aconfirmed.setAttribute("style", "float:right !important;margin-left: 5px;border: 1px solid #0071c5;" + "color: white;" + "text-align: center;" + "padding: 0 8px;" + "font-weight:bold;" + "background-color: #0071c5;" + "background-image: -webkit-gradient(linear, left top, left bottom, from(#0071c5), to(#4787ed));" + "background-image: -webkit-linear-gradient(top, #0071c5, #0071c5);" + "background-image: -moz-linear-gradient(top, #0071c5, #0071c5);" + "background-image: -ms-linear-gradient(top, #0071c5, #0071c5);" + "background-image: -o-linear-gradient(top, #0071c5, #0071c5);" + "background-image: linear-gradient(top, #0071c5, #0071c5);" + "-webkit-border-radius: 2px;" + "-moz-border-radius: 2px;" + "border-radius: 2px;" + "-webkit-user-select: none;" + "-moz-user-select: none;" + "user-select: none;" + "cursor: default;" + "display: inline-block;" + "text-align: center;" + "color: #fff;" + "font-size: 11px;" + "font-weight: bold;" + "height: 27px;" + "padding: 0 8px;" + "line-height: 27px;" + "line-height: 29px;" + "vertical-align: bottom;" + "height: 32px;" + "font-size: 13px;" + "color:#fff;" + "font-family: 'open sans';" + "margin: 0 0 0 2px;" + "height: 30px;" + "line-height: 30px;" + "color:#fff;cursor:pointer;margin-right: 20px;");
                }
                ...
                $(aconfirmed).mouseover(function () {
                    $(this).css("background-color", "#0071c5");
                    $(this).css("background-color", "-webkit-linear-gradient(top, #0071c5, #0071c5)");
                    $(this).css("background-color", "-moz-linear-gradient(top, #0071c5, #0071c5)");
                    $(this).css("background-color", "-ms-linear-gradient(top, #0071c5, #0071c5)");
                    $(this).css("background-color", "-o-linear-gradient(top, #0071c5, #0071c5)");
                    $(this).css("background-color", "linear-gradient(top, #0071c5, #0071c5)");
                    $(this).css("border", " 1px solid #0071c5");
                });
        ...
        var jui = {
                        ...
                        complete: function (jqXHR, textStatus) {
                            ...
                            if (jqXHR && jqXHR.status === 200) {
                                ...
                                if (jqXHR.responseText.length > 200) {
                                    if (message) jui.jalert(message);
                                    else jui.jalert("Something went wrong , check your application and try again. ");
                                    return;
                                }
            ...
            jalert: function (message, loader, OkLabel) {
                ...
                if (OkLabel) $("#" + jconfirmedId).html(OkLabel);
             ...
             * @param {float} opacity .
             */
            jloading: function (message,opacity) {
                //check the html elements exist
                if ($('#' + joverlayId).length === 0) {
                    buildHTML();
                }
                //check if opecity defined.
                if(opacity){
                    $('#' + joverlayId).css({
                        opacity: opacity
                    });
                ...
                //placing the message.
                if (message) $('#' + jloading_overlayId).html(message);
                else $('#' + jloading_overlayId).html('Saving');
                //showing the overlay.
             ...
             * @param {String} OkLabel text for the ok label.
             * @param {String} cancelLabel text for cancel button.
             */
            jconfirm: function (message, success, failer, OkLabel, cancelLabel) {
                if ($('#' + joverlayId).length === 0) {
                    buildHTML();
                }
                ...
                //replacing the OkLabel
                if (OkLabel) $("#" + jconfirmedId).html(OkLabel);
                //replacing the cancelLabel
                if (cancelLabel) $("#" + jcancelId).html(cancelLabel);
                //show cancel button
                $("#" + jcancelId).show();
                $('#' + jloading_overlayId).hide();
